...
const menuSections: MenuSection[] = [
  {
    ...
    items: [
      ...
      { path: "/admin/ops", label: "Leitstelle (Live-Betrieb)", icon: Radio, allowedRoles: OPS_STAFF },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/admin/fahrten", label: "Individuelle Fahrten", icon: Bus, allowedRoles: OPS_STAFF },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/admin/app", label: "Mobile App", icon: MonitorSmartphone, allowedRoles: MANAGEMENT },
