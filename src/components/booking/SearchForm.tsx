      ...
      <div className={cn(
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            />
            {showFromSuggestions && getAvailableFromStops().length > 0 && (
              <div className="absolute z-10 top-full left-0 right-0 mt-1 bg-card border border-border rounded-lg shadow-elevated overflow-hidden">
                {getAvailableFromStops().map((stop) => (
                  <button
                    key={stop.id}
                    type="button"
                    onClick={() => {
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            />
            {showToSuggestions && getAvailableToStops().length > 0 && (
              <div className="absolute z-10 top-full left-0 right-0 mt-1 bg-card border border-border rounded-lg shadow-elevated overflow-hidden">
        ...
        <div className={cn("self-end", isHero && "lg:col-span-1")}>
          <Button
            ...
            size="lg"
            className="w-full"
            disabled={!fromStop || !toStop || !departureDate}
          >
            <span>Suchen</span>
