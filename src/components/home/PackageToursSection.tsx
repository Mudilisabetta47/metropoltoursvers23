import { MapPin, Calendar, Palmtree, Star, ArrowRight, CircleArrowRight, CircleArrowLeft, Loader2 } from "lucide-react";
...
const PackageToursSection = () => {
  ...
  const getImageSrc = (imageUrl: string | null, destination: string) => {
    ...
    // Fallback based on destination name
              ...
              >
                ...
                <div className="relative h-40 overflow-hidden">
                  ...
                  {tour.discount_percent > 0 && (
                    <div className="absolute top-3 left-3 bg-accent text-accent-foreground px-2 py-0.5 rounded-full text-xs font-semibold">
                  ...
                  <div className="flex flex-col gap-1.5 text-muted-foreground text-xs mb-3">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="font-medium">Hin: {formatDate(tour.departure_date)}</span>
                      </div>
                      <span>–</span>
                      <div className="flex items-center gap-1">
                        <CircleArrowLeft className="w-3 h-3 text-primary" />
                        <span className="font-medium">Rück: {formatDate(tour.return_date)}</span>
                      </div>
                    </div>
                  </div>
