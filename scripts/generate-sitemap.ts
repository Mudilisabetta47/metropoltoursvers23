...
{ path: "/bus-mieten-hamburg", changefreq: "monthly", priority: "0.8" },
  { path: "/reisebus-mieten-hamburg", changefreq: "monthly", priority: "0.8" },
  { path: "/busvermietung-hamburg", changefreq: "monthly", priority: "0.8" },
  ...
  { path: "/busunternehmen-koeln", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-frankfurt", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-stuttgart", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-duesseldorf", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-leipzig", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-dresden", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-nuernberg", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-dortmund", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-essen", changefreq: "monthly", priority: "0.8" },
  { path: "/busunternehmen-braunschweig", changefreq: "monthly", priority: "0.8" },
...
/**
 * Hinweis: Es wird bewusst KEIN AggregateRating/Review-JSON-LD für das eigene
 * Unternehmen mehr erzeugt. Selbst verwaltete Bewertungen über das eigene
 * Unternehmen qualifizieren laut Google nicht für Review-Snippets und führten
 * zu mehrfachen AggregateRatings für dieselbe Entität.
 */
